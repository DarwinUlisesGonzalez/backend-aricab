...
const latestVersion = {
  ...
  pub_date: '2025-30-11T00:00:00Z',
  platforms: {
    windows: {
      url: 'https://api.aricab.shop/aplicacion/actualizar/aricab_5.1.0_x64-setup.exe',
    },
    linux: {
      url: 'https://api.aricab.shop/aplicacion/actualizar/aricab_5.1.0_amd64.deb',
    }
  }
};
